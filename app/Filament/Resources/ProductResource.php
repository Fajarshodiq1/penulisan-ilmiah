            ...
            Group::make()->schema([
                ...
                Section::make('Associations')->schema([
                    Select::make('category_id')
                        ...
                        ->label('Sub-Kategori')
                        ->options(Subcategory::where('category_id', '!=', 'sub_category') // Perbaiki kondisi
                                            ->pluck('name', 'id'))
                        ->searchable(),
                ]),
    ...
    return $table
        ->columns([
            ...
            TextColumn::make('price')
                ->label('Harga')
                ->formatStateUsing(fn ($state) => 'Rp ' . number_format($state, 0, ',', '.') . ',000') // Format uang Rupiah
                ->sortable(),
            IconColumn::make('is_featured')->label('Ditampilkan')->boolean(),
            IconColumn::make('on_sale')->label('Dijual')->boolean(),
            IconColumn::make('in_stock')->label('Persediaan')->boolean(),
